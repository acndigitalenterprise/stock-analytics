...
function initUserDetailForm() {
    ...
    form.addEventListener('submit', handleUserDetailSubmit);
}
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('📄 DOM Content Loaded - User Detail.js starting...');
    initUserDetailPage();
});

// Also try window.onload as fallback
window.addEventListener('load', function() {
    console.log('🪟 Window Load - User Detail.js fallback init...');
    // Try again after a delay
    setTimeout(() => {
        console.log('⏰ Delayed init - User Detail.js...');
        initUserDetailPasswordToggles();
    }, 500);
});

// Immediate check
console.log('🔧 User Detail.js file loaded!');
